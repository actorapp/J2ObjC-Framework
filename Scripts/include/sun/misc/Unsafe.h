...
//  source: android/platform/libcore/ojluni/src/objc/java/sun/misc/Unsafe.java
//
...
/*!
 ...
 with loads and stores after the fence.
 Implies the effects of both
...
inline jint SunMiscUnsafe_get_INVALID_FIELD_OFFSET();
