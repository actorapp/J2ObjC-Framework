...
/*!
 @brief Certificate is not yet valid exception.
 This is thrown whenever
...
/*!
 @brief Constructs a CertificateNotYetValidException with no detail message.
 A
...
inline jlong JavaSecurityCertCertificateNotYetValidException_get_serialVersionUID();
