...
//  source: android/platform/libcore/ojluni/src/objc/java/java/lang/ClassLoader.java
//
...
/*!
 @brief A class loader is an object that is responsible for loading classes.
 The
...
/*!
 @brief Returns the parent class loader for delegation.
...
/*!
 @brief Finds the resource with the given name.
...
/*!
 @brief Finds all the resources with the given name.
 A resource is some data
 (images, audio, text, etc) that can be accessed by class code in a way
 that is independent of the location of the code.
 <p>The name of a resource is a <tt>/</tt>-separated path name that
...
/*!
 @brief Returns the system class loader for delegation.
 This is the default
...
/*!
 ...
 classes.
 This method locates the resource through the system class
 loader (see <code>getSystemClassLoader()</code>).  </p>
 @param name
 The resource name
...
/*!
 ...
 This method locates the resource through the
 system class loader (see <code>getSystemClassLoader()</code>).  </p>
 @param name
 The resource name
 @return An input stream for reading the resource, or <tt>null</tt>
 if the resource could not be found
...
/*!
 ...
 load classes.
 The resources thus found are returned as an
...
/*!
 @brief Sets the package default assertion status for the named package.
 The
...
/*!
 ...
 the <code><tt>defineClass</tt></code>
  method that takes a
...
/*!
 @brief Converts an array of bytes into an instance of class <tt>Class</tt>,
 with an optional <tt>ProtectionDomain</tt>.
 If the domain is
 <tt>null</tt>, then a default domain will be assigned to the class as
 specified in the documentation for <code>defineClass(String,byte[],int,int)</code>
...
/*!
 @brief Defines a package by name in this <tt>ClassLoader</tt>.
 This allows
 ...
 respect to the given code source <code><tt>URL</tt></code>
...
/*!
 ...
 the <code><tt>loadClass</tt></code> method after checking the
...
/*!
 @brief Returns the absolute path name of a native library.
 The VM invokes this
...
/*!
 @brief Links the specified class.
 This (misleadingly named) method may be
...
/*!
 @brief Sets the signers of a class.
 This should be invoked after defining a
 class.  </p>
 @param c
