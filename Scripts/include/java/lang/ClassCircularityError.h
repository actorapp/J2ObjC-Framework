...
FOUNDATION_EXPORT JavaLangClassCircularityError *new_JavaLangClassCircularityError_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaLangClassCircularityError *create_JavaLangClassCircularityError_init();
