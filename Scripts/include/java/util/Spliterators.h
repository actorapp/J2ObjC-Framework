...
/*!
 ...
 @return An iterator
 @throws NullPointerException if the given spliterator is <code>null</code>
 */
...
/*!
 ...
 elements.  The characteristics <code>SIZED</code> and <code>SUBSIZED</code>
 are additionally reported unless <code>CONCURRENT</code> is supplied.
...
/*!
 ...
 of this spliterator's source or elements beyond <code>SIZED</code> and
...
/*!
 ...
 @return A spliterator for an array
 @throws NullPointerException if the given array is <code>null</code>
 @throws ArrayIndexOutOfBoundsException if <code>fromIndex</code> is negative,
...
/*!
 ...
 initial <code>estimateSize</code>
 @param characteristics Characteristics of this spliterator's source or
 elements.  The characteristics <code>SIZED</code> and <code>SUBSIZED</code>
 are additionally reported unless <code>CONCURRENT</code> is supplied.
 @return A spliterator from an iterator
...
/*!
 ...
 or elements (<code>SIZED</code> and <code>SUBSIZED</code>, if supplied, are
...
FOUNDATION_EXPORT id<JavaUtilSpliterator> JavaUtilSpliterators_emptySpliterator();

FOUNDATION_EXPORT id<JavaUtilSpliterator_OfInt> JavaUtilSpliterators_emptyIntSpliterator();

FOUNDATION_EXPORT id<JavaUtilSpliterator_OfLong> JavaUtilSpliterators_emptyLongSpliterator();

FOUNDATION_EXPORT id<JavaUtilSpliterator_OfDouble> JavaUtilSpliterators_emptyDoubleSpliterator();
...
/*!
 ...
 (see <code>spliterator(Iterator,long,int)</code>.  Depending on the
...
/*!
 ...
 source or elements.  If <code>SIZED</code> is reported then this
 spliterator will additionally report <code>SUBSIZED</code>.
 */
...
inline jint JavaUtilSpliterators_AbstractSpliterator_get_BATCH_UNIT();
...
inline jint JavaUtilSpliterators_AbstractSpliterator_get_MAX_BATCH();
...
FOUNDATION_EXPORT JavaUtilSpliterators_AbstractSpliterator_HoldingConsumer *new_JavaUtilSpliterators_AbstractSpliterator_HoldingConsumer_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilSpliterators_AbstractSpliterator_HoldingConsumer *create_JavaUtilSpliterators_AbstractSpliterator_HoldingConsumer_init();
...
/*!
 ...
 implement <code>tryAdvance(java.util.function.IntConsumer)</code>
 ...
 <p>An alternative to using this class, that also permits limited
 parallelism, is to create a spliterator from an iterator
 (see <code>spliterator(java.util.PrimitiveIterator.OfInt,long,int)</code>.
...
inline jint JavaUtilSpliterators_AbstractIntSpliterator_get_MAX_BATCH();
...
inline jint JavaUtilSpliterators_AbstractIntSpliterator_get_BATCH_UNIT();
...
FOUNDATION_EXPORT JavaUtilSpliterators_AbstractIntSpliterator_HoldingIntConsumer *new_JavaUtilSpliterators_AbstractIntSpliterator_HoldingIntConsumer_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilSpliterators_AbstractIntSpliterator_HoldingIntConsumer *create_JavaUtilSpliterators_AbstractIntSpliterator_HoldingIntConsumer_init();
...
/*!
 ...
 <p>To implement a spliterator an extending class need only
 implement <code>tryAdvance(java.util.function.LongConsumer)</code>
 tryAdvance}.  The extending class should override
 ...
 <p>An alternative to using this class, that also permits limited
 parallelism, is to create a spliterator from an iterator
 (see <code>spliterator(java.util.PrimitiveIterator.OfLong,long,int)</code>.
 Depending on the circumstances using an iterator may be easier or more
 convenient than extending this class. For example, if there is already an
 iterator available to use then there is no need to extend this class.
...
inline jint JavaUtilSpliterators_AbstractLongSpliterator_get_MAX_BATCH();
...
inline jint JavaUtilSpliterators_AbstractLongSpliterator_get_BATCH_UNIT();
...
FOUNDATION_EXPORT JavaUtilSpliterators_AbstractLongSpliterator_HoldingLongConsumer *new_JavaUtilSpliterators_AbstractLongSpliterator_HoldingLongConsumer_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilSpliterators_AbstractLongSpliterator_HoldingLongConsumer *create_JavaUtilSpliterators_AbstractLongSpliterator_HoldingLongConsumer_init();
...
/*!
 ...
 <code>trySplit</code> to permit limited parallelism.
 <p>To implement a spliterator an extending class need only
 implement <code>tryAdvance(java.util.function.DoubleConsumer)</code>
 tryAdvance}.  The extending class should override
 ...
 <p>An alternative to using this class, that also permits limited
 parallelism, is to create a spliterator from an iterator
 (see <code>spliterator(java.util.PrimitiveIterator.OfDouble,long,int)</code>.
 Depending on the circumstances using an iterator may be easier or more
 convenient than extending this class. For example, if there is already an
 iterator available to use then there is no need to extend this class.
...
inline jint JavaUtilSpliterators_AbstractDoubleSpliterator_get_MAX_BATCH();
...
inline jint JavaUtilSpliterators_AbstractDoubleSpliterator_get_BATCH_UNIT();
...
FOUNDATION_EXPORT JavaUtilSpliterators_AbstractDoubleSpliterator_HoldingDoubleConsumer *new_JavaUtilSpliterators_AbstractDoubleSpliterator_HoldingDoubleConsumer_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilSpliterators_AbstractDoubleSpliterator_HoldingDoubleConsumer *create_JavaUtilSpliterators_AbstractDoubleSpliterator_HoldingDoubleConsumer_init();
...
/*!
 ...
 operations.
 The spliterator implements <code>trySplit</code> to
 permit limited parallelism.
 */
...
/*!
 ...
 collection's <code>for traversal,</code>
 and reporting its <code>as its initial
 size.
 </code>
 @param c the collection
...
inline jint JavaUtilSpliterators_IteratorSpliterator_get_BATCH_UNIT();
...
inline jint JavaUtilSpliterators_IteratorSpliterator_get_MAX_BATCH();
...
inline jint JavaUtilSpliterators_IntIteratorSpliterator_get_BATCH_UNIT();
...
inline jint JavaUtilSpliterators_IntIteratorSpliterator_get_MAX_BATCH();
...
inline jint JavaUtilSpliterators_LongIteratorSpliterator_get_BATCH_UNIT();
...
inline jint JavaUtilSpliterators_LongIteratorSpliterator_get_MAX_BATCH();
...
inline jint JavaUtilSpliterators_DoubleIteratorSpliterator_get_BATCH_UNIT();
...
inline jint JavaUtilSpliterators_DoubleIteratorSpliterator_get_MAX_BATCH();
