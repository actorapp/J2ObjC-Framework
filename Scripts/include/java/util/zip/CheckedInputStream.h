...
FOUNDATION_EXPORT JavaUtilZipCheckedInputStream *create_JavaUtilZipCheckedInputStream_initWithJavaIoInputStream_withJavaUtilZipChecksum_(JavaIoInputStream *is, id<JavaUtilZipChecksum> csum);
