...
/*!
 ...
 average will be <code>NaN</code>.
  The <code>double</code> format can represent all
...
/*!
 ...
 transformation.
 For example, one could adapt the <code>toList()</code>
...
/*!
 ...
 If no elements are present, the
 result is 0.
...
@endcode
 ...
 collector is not required, using <code>groupingByConcurrent(Function)</code>
...
@endcode
 ...
 collector is not required, using <code>groupingByConcurrent(Function,Collector)</code>
 may offer better parallel performance.
...
/*!
 ...
 the values associated with a given key using the specified downstream
 <code>Collector</code>.
 The <code>Map</code> produced by the Collector is created
...
@endcode
 ...
 from one map into another, which can be an expensive operation.  If
 preservation of the order in which elements are presented to the downstream
 collector is not required, using <code>groupingByConcurrent(Function,Supplier,Collector)</code>
 may offer better parallel performance.
 @param classifier a classifier function mapping input elements to keys
 @param downstream a <code>Collector</code> implementing the downstream reduction
...
/*!
 ...
 operation on the values associated with a given key using the specified
 downstream <code>Collector</code>.
 The <code>ConcurrentMap</code> produced by the
...
/*!
 ...
 input elements under a specified <code>BinaryOperator</code>.
 The result
 ...
 use <code>Stream.reduce(BinaryOperator)</code> instead.
...
/*!
 ...
 multi-level reduction, downstream of <code>groupingBy</code> or
 <code>partitioningBy</code>.  To perform a simple reduction on a stream,
 use <code>Stream.reduce(Object,BinaryOperator)</code>} instead.
...
/*!
 ...
 use <code>Stream.map(Function)</code> and <code>Stream.reduce(Object,BinaryOperator)</code>
 instead.
...
/*!
 ...
 new <code>Collection</code>, in encounter order.
 The <code>Collection</code> is
...
/*!
 ...
 <code>java.util.function.Function.identity()</code> may be helpful.
...
@endcode
 ...
 to <code>Map.merge(Object,Object,BiFunction)</code>
 @return a concurrent, unordered <code>Collector</code> which collects elements into a
 <code>ConcurrentMap</code> whose keys are the result of applying a key mapping
 function to the input elements, and whose values are the result of
...
@endcode
 ...
 order, using <code>toConcurrentMap(Function,Function)</code>
 may offer better parallel performance.
 @param keyMapper a mapping function to produce keys
 @param valueMapper a mapping function to produce values
...
@endcode
 ...
 order, using <code>toConcurrentMap(Function,Function,BinaryOperator)</code>
 may offer better parallel performance.
 @param keyMapper a mapping function to produce keys
 @param valueMapper a mapping function to produce values
 @param mergeFunction a merge function, used to resolve collisions between
...
/*!
 ...
 from one map into another, which can be an expensive operation.  If it is
 not required that results are merged into the <code>Map</code> in encounter
 order, using <code>toConcurrentMap(Function,Function,BinaryOperator,Supplier)</code>
 may offer better parallel performance.
 @param keyMapper a mapping function to produce keys
 @param valueMapper a mapping function to produce values
 @param mergeFunction a merge function, used to resolve collisions between
...
inline id<JavaUtilSet> JavaUtilStreamCollectors_get_CH_CONCURRENT_ID();
...
inline id<JavaUtilSet> JavaUtilStreamCollectors_get_CH_CONCURRENT_NOID();
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline id<JavaUtilSet> JavaUtilStreamCollectors_get_CH_ID();
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline id<JavaUtilSet> JavaUtilStreamCollectors_get_CH_UNORDERED_ID();
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline id<JavaUtilSet> JavaUtilStreamCollectors_get_CH_NOID();
/*! INTERNAL ONLY - Use accessor function from above. */
...
FOUNDATION_EXPORT id<JavaUtilStreamCollector> JavaUtilStreamCollectors_toList();

FOUNDATION_EXPORT id<JavaUtilStreamCollector> JavaUtilStreamCollectors_toSet();

FOUNDATION_EXPORT id<JavaUtilStreamCollector> JavaUtilStreamCollectors_joining();
...
FOUNDATION_EXPORT id<JavaUtilStreamCollector> JavaUtilStreamCollectors_counting();
