...
/*!
 ...
 data element of a stream.
 Used when processing streams that can contain
 <code>null</code> elements to distinguish between a <code>null</code> value and no
 value.
 */
inline id JavaUtilStreamStreams_get_NONE();
...
FOUNDATION_EXPORT JavaUtilStreamStreams_StreamBuilderImpl *new_JavaUtilStreamStreams_StreamBuilderImpl_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilStreamStreams_StreamBuilderImpl *create_JavaUtilStreamStreams_StreamBuilderImpl_init();
...
FOUNDATION_EXPORT JavaUtilStreamStreams_IntStreamBuilderImpl *new_JavaUtilStreamStreams_IntStreamBuilderImpl_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilStreamStreams_IntStreamBuilderImpl *create_JavaUtilStreamStreams_IntStreamBuilderImpl_init();
...
FOUNDATION_EXPORT JavaUtilStreamStreams_LongStreamBuilderImpl *new_JavaUtilStreamStreams_LongStreamBuilderImpl_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilStreamStreams_LongStreamBuilderImpl *create_JavaUtilStreamStreams_LongStreamBuilderImpl_init();
...
FOUNDATION_EXPORT JavaUtilStreamStreams_DoubleStreamBuilderImpl *new_JavaUtilStreamStreams_DoubleStreamBuilderImpl_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilStreamStreams_DoubleStreamBuilderImpl *create_JavaUtilStreamStreams_DoubleStreamBuilderImpl_init();
