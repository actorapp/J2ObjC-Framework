...
/*!
 ...
 have been processed.
 Reduction operations can be performed either sequentially
 or in parallel.
...
@endcode
 ...
 in <code>Collectors</code> are functions that take a collector and produce
...
@endcode
 ...
 <code>Collectors.groupingBy(Function,Collector)</code>:
 @code
...
/*!
 @brief A function that accepts two partial results and merges them.
 The
...
/*!
 ...
 <code>accumulator</code>, and <code>combiner</code> functions.
 The resulting
 ...
 */
@interface JavaUtilStreamCollector_Characteristics : JavaLangEnum < NSCopying >
 ...
 */
inline JavaUtilStreamCollector_Characteristics *JavaUtilStreamCollector_Characteristics_get_CONCURRENT();
 ...
 */
inline JavaUtilStreamCollector_Characteristics *JavaUtilStreamCollector_Characteristics_get_UNORDERED();
...
/*!
 ...
 can be elided.
 If set, it must be the case that an unchecked cast
 from A to R will succeed.
 */
inline JavaUtilStreamCollector_Characteristics *JavaUtilStreamCollector_Characteristics_get_IDENTITY_FINISH();
J2OBJC_ENUM_CONSTANT(JavaUtilStreamCollector_Characteristics, IDENTITY_FINISH)

FOUNDATION_EXPORT IOSObjectArray *JavaUtilStreamCollector_Characteristics_values();
