...
/*!
 ...
 specifier of <code>java.util.Formatter</code>.
...
/*!
 ...
 @param formatter
 The <code>formatter</code>.  Implementing classes may call
 <code>formatter.out()</code> or <code>formatter.locale()</code>
  to obtain the <code>Appendable</code>
  or <code>Locale</code> used by this
 <tt>formatter</tt> respectively.
 @param flags
 The flags modify the output format.  The value is interpreted as
 a bitmask.  Any combination of the following flags may be set:
 <code>FormattableFlags.LEFT_JUSTIFY</code>, <code>FormattableFlags.UPPERCASE</code>
 ...
 the <code>FormattableFlags.LEFT_JUSTIFY</code> flag is set then the
