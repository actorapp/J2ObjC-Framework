...
/*!
 @brief Returns an empty <code>OptionalInt</code> instance.
...
/*!
 @brief Indicates whether some other object is "equal to" this OptionalInt.
 The
...
FOUNDATION_EXPORT JavaUtilOptionalInt *JavaUtilOptionalInt_empty();
