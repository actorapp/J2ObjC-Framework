...
/*!
 ...
 enum.
 For example, the following code produces <code>"true"</code>.
 <blockquote>
@code
...
/*!
 ...
 range(s).
 The Latin-1 (EUROPEAN) digits are converted to the
 ...
 @throws NullPointerException if <code>ranges</code> is <code>null</code>.
 @since 1.7
 */
...
/*!
 @brief Returns a shaper for the provided unicode range.
 All
...
/*!
 ...
 range.
 All Latin-1 (EUROPEAN) digits are converted to the
 ...
 @throws NullPointerException if <code>singleRange</code> is <code>null</code>
 @since 1.7
 */
...
/*!
 ...
 such as <code>NumericShaper.Range.EUROPEAN</code>
...
/*!
 @brief Returns a <code>String</code> that describes this shaper.
 This method
...
/*!
 ...
 For example, the <code>NumericShaper.Range.THAI</code>
...
@endcode</blockquote>
 @since 1.7
 */
@interface JavaAwtFontNumericShaper_Range : JavaLangEnum < NSCopying >
 ...
 */
inline JavaAwtFontNumericShaper_Range *JavaAwtFontNumericShaper_Range_get_TAI_THAM_THAM();
J2OBJC_ENUM_CONSTANT(JavaAwtFontNumericShaper_Range, TAI_THAM_THAM)

/*!
 @brief The Javanese range with the Javanese digits.
 */
inline JavaAwtFontNumericShaper_Range *JavaAwtFontNumericShaper_Range_get_JAVANESE();
J2OBJC_ENUM_CONSTANT(JavaAwtFontNumericShaper_Range, JAVANESE)

/*!
 @brief The Meetei Mayek range with the Meetei Mayek digits.
 */
inline JavaAwtFontNumericShaper_Range *JavaAwtFontNumericShaper_Range_get_MEETEI_MAYEK();
J2OBJC_ENUM_CONSTANT(JavaAwtFontNumericShaper_Range, MEETEI_MAYEK)

FOUNDATION_EXPORT IOSObjectArray *JavaAwtFontNumericShaper_Range_values();
