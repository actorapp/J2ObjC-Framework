...
/*!
 @brief Closing a <tt>ByteArrayInputStream</tt> has no effect.
 The methods in
 this class can be called after the stream has been closed without
 generating an <tt>IOException</tt>.
 <p>
...
/*!
 @brief Tests if this <code>InputStream</code> supports mark/reset.
 The
...
/*!
 @brief Resets the buffer to the marked position.
 The marked position
