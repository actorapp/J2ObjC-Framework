...
/*!
 @brief Creates a new byte array output stream.
...
/*!
 @brief Closing a <tt>ByteArrayOutputStream</tt> has no effect.
 The methods in
 this class can be called after the stream has been closed without
 generating an <tt>IOException</tt>.
 <p>
...
/*!
 ...
 The length of the new <tt>String</tt>
...
/*!
 @brief Creates a newly allocated string.
 Its size is the current size of
...
/*!
 ...
 the specified <code>charsetName</code>.
 The length of
