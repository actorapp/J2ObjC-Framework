...
//  source: android/platform/libcore/ojluni/src/objc/java/java/sql/SQLException.java
//
...
/*!
 ...
 <code>reason</code>.
 The  <code>SQLState</code>  is initialized to
...
/*!
 @brief Returns an iterator over the chained SQLExceptions.
 The iterator will
...
FOUNDATION_EXPORT void JavaSqlSQLException_initWithNSException_(JavaSqlSQLException *self, NSException *cause);

FOUNDATION_EXPORT JavaSqlSQLException *new_JavaSqlSQLException_initWithNSException_(NSException *cause) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaSqlSQLException *create_JavaSqlSQLException_initWithNSException_(NSException *cause);

FOUNDATION_EXPORT void JavaSqlSQLException_initWithNSString_withNSException_(JavaSqlSQLException *self, NSString *reason, NSException *cause);

FOUNDATION_EXPORT JavaSqlSQLException *new_JavaSqlSQLException_initWithNSString_withNSException_(NSString *reason, NSException *cause) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaSqlSQLException *create_JavaSqlSQLException_initWithNSString_withNSException_(NSString *reason, NSException *cause);

FOUNDATION_EXPORT void JavaSqlSQLException_initWithNSString_withNSString_withNSException_(JavaSqlSQLException *self, NSString *reason, NSString *sqlState, NSException *cause);

FOUNDATION_EXPORT JavaSqlSQLException *new_JavaSqlSQLException_initWithNSString_withNSString_withNSException_(NSString *reason, NSString *sqlState, NSException *cause) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaSqlSQLException *create_JavaSqlSQLException_initWithNSString_withNSString_withNSException_(NSString *reason, NSString *sqlState, NSException *cause);

FOUNDATION_EXPORT void JavaSqlSQLException_initWithNSString_withNSString_withInt_withNSException_(JavaSqlSQLException *self, NSString *reason, NSString *sqlState, jint vendorCode, NSException *cause);

FOUNDATION_EXPORT JavaSqlSQLException *new_JavaSqlSQLException_initWithNSString_withNSString_withInt_withNSException_(NSString *reason, NSString *sqlState, jint vendorCode, NSException *cause) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaSqlSQLException *create_JavaSqlSQLException_initWithNSString_withNSString_withInt_withNSException_(NSString *reason, NSString *sqlState, jint vendorCode, NSException *cause);
...
FOUNDATION_EXPORT JavaSqlSQLException_NextExceptionUpdater *new_JavaSqlSQLException_NextExceptionUpdater_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaSqlSQLException_NextExceptionUpdater *create_JavaSqlSQLException_NextExceptionUpdater_init();
