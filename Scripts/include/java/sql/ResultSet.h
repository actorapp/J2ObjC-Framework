...
/*!
 ...
 Unicode characters.
 The first byte is the high byte; the second
...
/*!
 @brief Retrieves the current row number.
 The first row is number 1, the
...
/*!
 @brief Retrieves whether the current row has been updated.
 The value returned
...
/*!
 @brief Retrieves whether a row has been deleted.
 A deleted row may leave
...
/*!
 @brief Moves the cursor to the insert row.
...
/*!
 ...
 current row.
 This method has no effect if the cursor is not on
 the insert row.
 @exception SQLException if a database access error occurs; this
 method is called on a closed result set
 or the result set concurrency is <code>CONCUR_READ_ONLY</code>
...
/*!
 @brief Updates the designated column with a <code>RowId</code> value.
 The updater
...
/*!
 @brief Retrieves whether this <code>ResultSet</code> object has been closed.
...
/*!
 @brief Updates the designated column using the given input stream.
 The data will be read from the stream
 as needed until end-of-stream is reached.
 <p>
 The updater methods are used to update column values in the
