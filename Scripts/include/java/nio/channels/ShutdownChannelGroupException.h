...
FOUNDATION_EXPORT JavaNioChannelsShutdownChannelGroupException *new_JavaNioChannelsShutdownChannelGroupException_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaNioChannelsShutdownChannelGroupException *create_JavaNioChannelsShutdownChannelGroupException_init();
